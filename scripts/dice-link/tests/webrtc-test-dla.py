...
async def handle_generate_offer(request):
    ...
    try:
        ...
        # Note: a=max-message-size is optional and causes Chrome to reject the SDP
        # when generated by external sources (even though Chrome accepts it in browser-generated SDPs)
        # Removing it to ensure compatibility
