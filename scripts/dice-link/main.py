...
def main():
    ...
    upnp_success = setup_upnp_port_forward(WEBSOCKET_PORT, description="Dice Link")
    if upnp_success:
        print(f"Remote connections enabled via UPnP")
    ...
    if upnp_success:
        print(f"Cleaning up UPnP port forwarding...")
